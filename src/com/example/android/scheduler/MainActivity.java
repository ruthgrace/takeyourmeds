...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Debug.startMethodTracing("tracelog.txt");
        
        final Button button = (Button) findViewById(R.id.addalarmbutton);
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	Intent intent = new Intent(v.getContext(), AlarmFragmentActivity.class);
...
/*    public void setAlarm(View view) {
    	Intent intent = new Intent(view.getContext(), AlarmFragmentActivity.class);
    	startActivity(intent);
    }*/
